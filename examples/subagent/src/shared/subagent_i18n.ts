export type SubagentI18n = {
  stageAccepted: string;
  stagePlanningTargets: string;
  stagePlanningTask: string;
  stageExecuting: string;
  stageSummarizing: string;
  toolTriggeredGeneric: string;
  toolCalledPrefix: (toolName: string) => string;
  errorNoAppContext: string;
  errorNoSummary: string;
  errorExecutionFailedPrefix: (error: string) => string;
  stageLabelAccepted: string;
  stageLabelPlanning: string;
  stageLabelTool: string;
  stageLabelExecuting: string;
  stageLabelSummarizing: string;
  stageLabelDefault: string;
  titleStarted: string;
  titleCompleted: string;
  titleFailed: string;
  badgeSuccess: string;
  badgeFailure: string;
  detailTargetCount: (count: number) => string;
  badgeTargetCount: (count: number) => string;
  detailRun: (runId: string) => string;
  badgeToolCount: (count: number) => string;
  detailToolCalls: (count: number) => string;
};

const ZH_CN: SubagentI18n = {
  stageAccepted: "已接受任务",
...
export function resolveSubagentI18n(useEnglish?: boolean | string): SubagentI18n {
